...
class PDFProcessor:
    def __init__(self, chunk_size: int = 500, chunk_overlap: int = 100):  # Reduced chunk size for better context
    ...
    def clean_text(self, text: str) -> str:
        ...
        text = re.sub(r'[^\w\s.,!?;:()\-"\'₹]', '', text)  # Preserved ₹ symbol
        text = re.sub(r'\.{2,}', '.', text)
        text = re.sub(r'\s+([.,!?;:])', r'\1', text)
        # Remove redundant whitespace while preserving sentence boundaries
        ...
        for text, page_num in text_with_pages:
            ...
            for sentence in sentences:
                ...
                if current_length + sentence_length > self.chunk_size and current_chunk:
                    ...
                    if len(chunk_text) >= 50:  # Minimum chunk size threshold
...
class HybridRetriever:
    def __init__(self, model_name: str = 'sentence-transformers/all-mpnet-base-v2'):  # Using a more powerful model
    ...
    def search(self, query: str, k: int = 5) -> List[SearchResult]:
        ...
        min_score_threshold = 0.4  # Increased threshold for better quality
...
Maintain a helpful and friendly tone throughout all interactions."""
    ...
    def is_information_seeking_query(self, query: str) -> bool:
        # Keywords that suggest an information-seeking query
        info_keywords = [
...
Remember: This is a casual conversation. Respond in a friendly and natural way while maintaining context about being an assistant for people of Haryana. Do not make up any specific information about government schemes or benefits."""
    ...
    def generate_response(self, user_input: str) -> str:
        # Determine if this is an information-seeking query
        ...
        # For information-seeking queries, use the RAG system
...
print("RAG Chatbot classes defined successfully!")

chatbot = None  # Global variable to hold the instance
...
def clear_history():
    try:
        chatbot.conversation_history = [chatbot.conversation_history[0]]  # Keep system prompt
